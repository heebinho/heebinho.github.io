...
Following you'll find the required classes/methods to compile the example with the aforementioned ToFunc() extension method(s) and a Unit() method, which returns a System.ValueTuple and means "no return value":
...
For me there's conceptually much more to learn in the fp world and presumably I'll write about some topics.
